  ...
  create  table "dbt_mktg"."stripe_invoices_with_line_items_xf_aggregated__dbt_tmp"
...
with stripe_invoices_with_line_items_year_adjusted as (
  ...
  from 
    "dbt_mktg"."stripe_invoices" as stripe_invoices
  join
    "dbt_mktg"."stripe_invoice_line_items" as invoice_line_items
  on
